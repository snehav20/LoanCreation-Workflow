		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#Loansworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Loansworkflowuimodule-display": {
								"semanticObject": "Loansworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Loans.workflowuimodule",
									"url": sap.ui.require.toUrl("Loans/workflowuimodule")
								}
							}
						}
					}
